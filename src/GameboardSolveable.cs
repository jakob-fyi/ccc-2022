...
public class GameboardSolveable
{
    public int NumberOfMaxMoves { get; set; }
    ...
    bool checkCollision()
    {
        ...
        if (Fields[PackmanX, PackmanY] == Gamefigures.Wall || Fields[PackmanX, PackmanY] == Gamefigures.Ghost)
        {
            return true;
        }
